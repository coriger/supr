...
public class FreeMarkerUtil extends FreeMarkerView {
	...
	protected void doRender(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		/*
		 * 在这里我们默认生成静态文件,当ModelAndView有指定STATIC_HTML = false时,就不会输出HTML文件 例如：ModelAndView modelAndView = new ModelAndView("htmlTest"); modelAndView.addObject("STATICHTML", false);
		 */
