			...
			<div id="content">
				...
				<div class="pb-wrapper clearfix">
					<div id="pb-main">
						...
						<form action="./blog/update" method="post" id="form">
						<div id="pb-post-area">
							<div id="pb-text-title-holder" class="pb-post-section">
								...
								<input tabindex="1" type="text" name="title"
									class="pb-input-text" id="pb-text-title" value="${requestScope.blog.title}">
							</div>
						...
						<div id="pb-action-holder" class="clearfix">
							<div class="pb-submit" onclick="updateBlog()">
						...
						<input type="hidden" id="tags" name="tagIds" values="${requestScope.blog.tagIds}"/>
						<input type="hidden" name="postFix" value="${requestScope.blog.postFix}"/>
								...
								<div id="post-tag-holder" class="aside-item">
									<div id="post-tag">
										<ul id="post-tag-list" class="clearfix">
											<!-- 标签添加位置 -->
											<c:forEach items="${requestScope.blog.tag}" var="tag">
												<li id="${tag.tagId}" tag="${tag.tagName}">
													<span>${tag.tagName}</span>
													<a onclick="deleteTag('${tag.tagId}')" title='删除' class='delete-tag-btn'>x</a>
												</li>									
											</c:forEach>
										</ul>
